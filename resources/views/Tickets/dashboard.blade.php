        ...
        <table class="table table-hover mb-0">
            <thead>
                <tr>
                    ...
                    <th class="text-center"><button class="btn" onclick="fetchdData(this.value)" value="dateCreated">Date Created</button></th>
            ...
            @foreach($ticket as $items)
                <tr>
                    <td class="text-center"><a href="/ticket/{{$items->id}}">{{$items->id}}</a></td>
                    ...
                    @endif
                    @if($items->type == 1 )
                        <td class="text-center"><i class="fas fa-photo-video"></i> Media</td>
                    @elseif($items->type == 2)
